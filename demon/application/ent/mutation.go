...
func withWeatherStationID(id int) weatherstationOption {
...
func (m *WeatherStationMutation) ID() (id int, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
func (m *WeatherStationMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
...
func (m *WeatherStationMutation) SetName(s string) {
	m.name = &s
}

// Name returns the value of the "name" field in the mutation.
func (m *WeatherStationMutation) Name() (r string, exists bool) {
	v := m.name
	if v == nil {
		return
	}
...
// OldName returns the old "name" field's value of the WeatherStation entity.
// If the WeatherStation object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *WeatherStationMutation) OldName(ctx context.Context) (v string, err error) {
...
func (m *WeatherStationMutation) ResetName() {
	m.name = nil
}
...
func (m *WeatherStationMutation) Fields() []string {
	...
	if m.name != nil {
		fields = append(fields, weatherstation.FieldName)
	}
	return fields
}
