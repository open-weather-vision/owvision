...
_responseData = rawData == null ? null : deserialize<List<Station>, Station>(rawData, 'List<Station>', growable: true);
  ...
  Future<Response<Error>> stationsConnect({ 
    ...
    final _path = r'/stations/{id}/live'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<Error, Error>(rawData, 'Error', growable: true);
  ...
  Future<Response<StationAndSensors>> stationsOne({ 
    ...
    final _path = r'/stations/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    StationAndSensors? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<StationAndSensors, StationAndSensors>(rawData, 'StationAndSensors', growable: true);
    ...
    return Response<StationAndSensors>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
