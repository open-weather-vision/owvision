...
export interface DaemonRestApiClientContext extends Client {

}export interface DaemonRestApiClientOptions extends ClientOptions {
  endpoint?: string;
}export function createDaemonRestApiClientContext(
