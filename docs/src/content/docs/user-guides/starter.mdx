...
1.  **Check if your weather station is supported**
    ...
    <LinkButton
        target="_blank"
        href="/docs/reference/supported-stations"
        variant="secondary"
    >
        Check support
    </LinkButton>
    ...
    :::note
    There is an [official guide](/docs/developer-guides/station-interface) that explains how to write your own interface and add support for your weather station.
    :::
...
3.  **Open owvision.local in your webbrowser**
    ...
    :::note
    There is also a [cli](/docs/cli) (command line interface) that offers the same features as the gui in a more condensed way.
    :::
