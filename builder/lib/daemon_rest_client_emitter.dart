...
class DaemonRESTClientEmitter {
  /// Generates all daemon clients based on the current REST API specification and sets their version to the passed value.
  Future<void> emit(String version) async {
